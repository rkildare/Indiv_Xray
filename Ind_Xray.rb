...
def mmat(obj)
	...
	if (!obj.nil?)
		...
		if(model.materials[col].nil?)
			...
			if (!obj.texture.nil?)
				mat.texture = stupid_routine(obj)
...
if( not file_loaded?("Ind_Xray.rb") )###
	...
	UI.menu("Plugins").add_item("Individual_Xray") { iXray }
